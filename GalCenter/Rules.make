...
AR = ar  rcv
RANLIB = ranlib
#OPT = -g  -qopenmp -DDEBUG -DINDEX -DVarPM   -DXYZDBL  -DQUADHILBERT -DNENER=0 -DNVAR=11 -DNPRE=8 -DOUTPUT_PARTICLE_POTENTIAL #-DDEBUG
OPT = -g  -qopenmp -DINDEX -DVarPM   -DXYZDBL  -DQUADHILBERT -DNENER=0 -DNPRE=8 -DREAD_SINK -DNCHEM=9 -DNDUST=4
...
DFLAGS = -DNMEG=5000L -D_LARGE_FILES #-DCHECK_INFORM
#
